"""
Utilities to create rotated + center-cropped query images for robustness tests.
...
class QuerySummary:
    """Simple record describing a generated query image."""
...
def build_query_image(
    ...
    """
    Rotate and crop the provided image to build a query variant.
...
def generate_queries_for_directory(
    source_dir: Path,
